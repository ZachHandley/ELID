 ...
 */
export function embedTextFromBytes(text: string, safetensors_bytes: Uint8Array, tokenizer_json: Uint8Array, config_json: Uint8Array): Float32Array;
 ...
 * ```
 */
export function initTextModel(): Promise<void>;
...
export interface InitOutput {
    ...
    readonly embedText: (a: number, b: number) => [number, number, number, number];
    readonly embedTextFromBytes: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number, number];
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h66d42c658e20be21: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h212e4b04e021a1b3: (a: number, b: number, c: any, d: any) => void;
