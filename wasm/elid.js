...
export function embedText(text) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.embedText(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {Float32Array}
 */
export function embedTextFromBytes(text, safetensors_bytes, tokenizer_json, config_json) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(safetensors_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(tokenizer_json, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passArray8ToWasm0(config_json, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.embedTextFromBytes(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {string[]}
 */
export function embeddingToBands(embedding, num_bands, seed) {
    const ptr0 = passArrayF64ToWasm0(embedding, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.embeddingToBands(ptr0, len0, num_bands, !isLikeNone(seed), isLikeNone(seed) ? BigInt(0) : seed);
 ...
 */
export function initTextModel() {
    const ret = wasm.initTextModel();
    return ret;
}
 ...
 * @returns {string[]}
 */
export function mini128ToBands(hash, num_bands) {
    const ptr0 = passArray8ToWasm0(hash, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.mini128ToBands(ptr0, len0, num_bands);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_bf31d18f92484486: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h212e4b04e021a1b3(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h66d42c658e20be21);
            return ret;
        },
...
function wasm_bindgen__convert__closures_____invoke__h66d42c658e20be21(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h66d42c658e20be21(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h212e4b04e021a1b3(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h212e4b04e021a1b3(arg0, arg1, arg2, arg3);
}

const SimilarityOptionsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_similarityoptions_free(ptr, 1));
